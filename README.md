...
## หมายเหตุ
- โครงการนี้จัดทำขึ้นเพื่อเป็นพื้นที่ทดลองและพัฒนาต่อยอด จึงอาจประกอบด้วยทั้งข้อมูลที่ใช้งานจริง และโครงสร้างรองรับงานในอนาคต
- โครงการนี้จัดทำขึ้นเพื่อประโยชน์ในการศึกษาพระบาลีของคณะสงฆ์ และเพื่ออำนวยความสะดวกแก่ครูบาอาจารย์ผู้สอนในการจัดทำข้อสอบเท่านั้น
- ข้อมูลหนังสือใน `data/` คัดลอกมาจากโปรแกรม BUDSIR 7 และโปรแกรมพระไตรปิฎก (TPD) และมีการแก้ไข/ปรับปรุงเพิ่มเติมในส่วนของคำแปลเพื่อใช้ในการศึกษาเท่านั้น มิได้จัดทำขึ้นเพื่อการใช้ประโยชน์เชิงพาณิชย์
- แหล่งอ้างอิงของโปรแกรมต้นทาง: TPD ที่ http://www.learntripitaka.com/Download.html และ BUDSIR 7 ที่ https://mahidol.ac.th/budsir/orderT.php
...
## การอ้างอิงที่มา
- ดูรายละเอียดคำขอความร่วมมือในการอ้างอิงที่มาได้ที่ [NOTICE.md](file:///d:/Pali-Exam-Builder/NOTICE.md)
